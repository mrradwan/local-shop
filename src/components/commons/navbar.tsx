                ...
                <div className="relative w-full">
                  <Field>
                    <ButtonGroup>
                      ...
                      <Button
                        variant="outline"
                        className="hover:text-green-600 hover:bg-green-50 hover:border-green-600"
                      >
                        Search
                      </Button>
                    </ButtonGroup>
                    ...
                    <SheetHeader>
                      ...
                      <Field className="p-4 border-b border-gray-200">
                        <ButtonGroup className="relative">
                          ...
                          />
                          <Button className="absolute -right-1 top-0 translate-y-0 w-8 h-8 bg-green-600 text-white flex items-center justify-center">
                            <Search />
                          </Button>
                        </ButtonGroup>
                      </Field>
