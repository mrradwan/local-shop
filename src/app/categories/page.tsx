...
export default async function Categories() {
  // 🌟 بنجيب الداتا هنا مباشرة على السيرفر
  ...
  const pageDetails = {
    ...
    parentName: "", // مش هنحتاجه هنا لأن مفيش أب
    parentLink: "", // مش هنحتاجه بردو
    image: null,
  ...
  return (
    <div className="min-h-screen bg-gray-50/50">
      ...
      {/* 🌟 الهيدر في سطر واحد بس ومفيش فلاتر (hasFilters={false}) */}
      <PageHeader details={pageDetails} hasFilters={false} />

      <div className="container mx-auto px-4 py-10">
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 sm:gap-6">
          {/* 🌟 بنعمل لوب على الأقسام اللي جاية من الـ API */}
